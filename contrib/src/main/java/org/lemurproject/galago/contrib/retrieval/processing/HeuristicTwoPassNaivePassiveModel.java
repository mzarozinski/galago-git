 ...
 * @author sjh
 */
public class HeuristicTwoPassNaivePassiveModel extends ProcessingModel {

  private LocalRetrieval retrieval;
  private NaivePassiveModel naivePassive;

  public HeuristicTwoPassNaivePassiveModel(LocalRetrieval lr) {
    this.retrieval = lr;
    this.naivePassive = new NaivePassiveModel(lr);
  }
  ...
  public List<ScoredDocument> executeQuery(Node queryTree, Parameters queryParams) throws Exception {
    ...
    FixedSizeMinHeap<ScoredDocument> queue = naivePassive.naivePassiveAlgorithm(simpleScoringNodes, fpRequested, queryParams);
