 ...
 * @author sjh
 */
public class MemoryPositionalIndexCountSource extends MemValueSource implements CountSource {
  ...
  public MemoryPositionalIndexCountSource(PositionalPostingList data) throws IOException {
    super(data.key());
    this.postings = data;
    reset();
  }
